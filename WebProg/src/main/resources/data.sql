...
Insert into Trener (korisnicko_ime,lozinka,ime,prezime,kontakt_telefon,email,datum_rodjenja,uloga,aktivan) values ('Luka123','123123','Luka','Nestorovic','065444','luka@gmail.com','2001-02-12','Trener',true);
...
Insert into Termin (cena,datum_vreme) values (500,'2021-05-01');

Insert into Trening (naziv,opis,tip_treninga,trajanje) values ('Kardio','Trcanje','Kardio',2);
...
Insert into Sala (kapacitet,oznaka_sale) values (200,'101');